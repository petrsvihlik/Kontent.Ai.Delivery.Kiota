using Kontent.Ai.Delivery.Kiota.Item.Types.Item;
...
namespace Kontent.Ai.Delivery.Kiota.Item.Types {
    /// <summary>Builds and executes requests for operations under \{project_id}\types</summary>
    public class TypesRequestBuilder {
        ...
        /// <summary>Gets an item from the Kontent.Ai.Delivery.Kiota.item.types.item collection</summary>
        public WithType_codenameItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("type_codename", position);
            return new WithType_codenameItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// </summary>
        public TypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/{project_id}/types{?elements,skip*,limit*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TypesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<TypesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<TypesResponse> GetAsync(Action<TypesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<TypesResponse>(requestInfo, TypesResponse.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>Retrieve a paginated list of content types in your project. By default, the API returns all content types ordered alphabetically by codename. You can customize pagination by specifying both the `skip` and `limit` query parameters.</summary>
