...
namespace Kontent.Ai.Delivery.Kiota.Item.Types {
    public class TypesResponse : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new typesResponse and sets the default values.
        /// </summary>
        ...
        /// </summary>
        public static TypesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"types", n => { Types = n.GetCollectionOfObjectValues<ContentType>(ContentType.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ContentType>("types", Types);
